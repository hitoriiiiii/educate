...
<template>
    <div class="executeStatistics">
        ...
        <div class="digitization">
            <div class="title">本月执行概况</div>
            <div class="statistic">
                <a-row>
                    <a-col :span="12">
                        <!-- <a-statistic title="正在批改" :value=statistic.following /> -->
                        <a-statistic title="已批改数" :value=statistic.complete />
                    </a-col>
                    <a-col :span="12">
                        <!-- <a-statistic title="逾期未批改" :value=statistic.lateFollow /> -->
                        <a-statistic title="未批改数" :value=statistic.nofollow />

                    </a-col>
                </a-row>
                <a-row> 
                    <a-col :span="12">
                        <!-- <a-statistic title="批改异常" :value=statistic.abnormal /> -->
                        <a-statistic title="逾期未批改数" :value=statistic.latenofollow />

                    </a-col>
                    <a-col :span="12">
                        <!-- <a-statistic title="终止批改" :value=statistic.end /> -->
                        <a-statistic title="批改异常" :value=statistic.abnormal />
                    </a-col>
                </a-row>
            </div>
...
import { getMonthInfoApi } from '@/api/nurse/nurseWorkbench'
    ...
    if(loaded.value){
        ...
        const option = {
            ...
            series: [{
                ...
                data: [
                    { value: statistic.value.complete, name: '已批改数' },
                    { value: statistic.value.nofollow, name: '未批改数' },
                    { value: statistic.value.latenofollow, name: '预期未批改数' },
                    { value: statistic.value.abnormal, name: '批改异常' },
                ]
            }]
        }
