...
<template>
  <div class="followListCard">
    ...
    <div class="tableTitle" >
      ...
      <span class="tableTitleText" @click="jumpToFollow">待评价列表</span>
    </div>
    <!-- 表格内容 -->
        ...
        <template #bodyCell="{ column, record }">
          ...
          <template v-if="column.key === 'operation'">
            <!-- 当状态为已评价时，操作栏的“去评价”变成灰色，且不能点击；否则“去评价”为绿色，且点击可以去评价 -->
              ...
              <span v-else><a @click="jumpToFollowDetail" style="color: #5470C6;font-weight:500">去评价</a></span>
          </template>
        </template>
      </a-table>
    </div>
...
import { getFollowListApi } from '@/api/teacher/teacherWorkbench'
