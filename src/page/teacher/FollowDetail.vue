    ...
    <div class="contentBody">
        ...
        <div class="questionnaire">
            ...
            <div class="questionnaireHead">
                <!-- 表头文字 -->
                <span class="questionnaireName">智能评价生成问卷</span><br>
                <span class="questionnaireNotice">
                    <p>本问卷手机您的评价，生成对学生的具体评价</p>
                </span>
                <!-- 异常情况选择 -->
            ...
            <div class="questionnaireContext">
                ...
                >
                    ...
                    >
                        <span style="line-height: 50px;">评价关键词：</span>
                        <a-textarea
                            placeholder="请输入简略的评价的内容，AI帮您生成完整评价"
                    ...
                    >
                        ...
                        <a-textarea
                            placeholder="此处显示生成后的评价，您可以在此进行修改"
                            :auto-size="{ minRows: 5, maxRows: 5 }"
                            :style="{width: '85%'}"
...
import { postApi,executeApi} from '@/api/teacher/executeApi'
// import {postApi,executeApi} from '@/api/teacher/followApi'
...
let handledtext = computed(() => {
  return `根据关键词：该生总体学习情况${studyvalue}，${sendText.value}，补全成为一份完整评价`;
});
const getanswer = () => {
            spinning.value = true;
...
// const postApi = (dialogue) => new Promise((resolve, reject) =>{
//     let data =  dialogue
...
//     // let url='api/api/dialog/{{uid}}/post_dialogues?token={{token}}&type=0&teacher_id={{uid}}'
//     let url = 'api/api/dialog/' + uid + '/post_dialogues?token=' + token + '&type=1&teacher_id=' + uid +'&student_id=' + id;
//     console.log(url)
//     console.log(data)
//     axios({
//         method:'post',
...
const postData = () =>{
      ...
      if (dialogue){
        postApi(dialogue,studentInfo.value.id).then((res)=>{
